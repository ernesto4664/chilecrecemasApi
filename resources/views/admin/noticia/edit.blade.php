            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        @if($noticia->imagen)
                            <div class="mt-2">
                                <img src="{{ asset($noticia->imagen) }}" alt="Imagen actual" class="img-thumbnail" width="150">
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="status" name="status">
                            ...
                            <option value="Destacada" {{ $noticia->status == 'Destacada' ? 'selected' : '' }}>Destacada</option>
                            <option value="Archivada" {{ $noticia->status == 'Archivada' ? 'selected' : '' }}>Archivada</option>
                        </select>
                    </div>
                    <div class="form-group">
